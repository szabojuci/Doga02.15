...
export default function AdminSzallasGet(props) {
                ...
                <div>
                    ...
                    {accommodation.map((accommodation) => (
                        <div key={accommodation.id + 4} className='card col-sm-3 d-inline-block m-1 p-2'>
                            ...
                            <br />
                            <NavLink key={accommodation.id+1} to={"/szallasput/" + accommodation.id}>
                                <i className="bi bi-pencil-square mx-1">Módosítás</i>
                            </NavLink>
                            <NavLink key={accommodation.id+2} to={"/szallasdelete/" + accommodation.id} className={"text-danger"}>
